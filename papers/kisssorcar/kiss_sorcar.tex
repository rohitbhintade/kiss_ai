...
- If the user ask to open or edit the system prompt, open
  ~/.vscode/extensions/ksenxx.kiss-sorcar-2026.5.5/
...
- Official Claude SKILLS are available under the folder
  kiss/agents/claude_skills
