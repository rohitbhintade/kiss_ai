...
- If the user ask to open or edit the system prompt, open ~/.vscode/extensions/ksenxx.kiss-sorcar-2026.4.7/kiss_project/src/kiss/SYSTEM.md
- If the user ask to open or modify the configuration, 
  open ~/.vscode/extensions/ksenxx.kiss-sorcar-2026.4.7/kiss_project/src/kiss/
- If the user wants to modify the config file, 
  open ~/.vscode/extensions/ksenxx.kiss-sorcar-2026.4.7/kiss_project/src/kiss/core/config.py
