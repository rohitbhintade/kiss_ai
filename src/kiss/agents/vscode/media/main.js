...
(function() {
  ...
  function showMergeToolbar() {
    ...
    bar.innerHTML =
      ...
      + '<button class="merge-btn merge-accept" id="merge-accept-btn" data-tooltip="Accept current change">\u2713 Accept</button>'
      + '<button class="merge-btn merge-reject" id="merge-reject-btn" data-tooltip="Reject current change">\u2717 Reject</button>'
      + '<button class="merge-btn merge-nav" id="merge-prev-btn" data-tooltip="Previous change">\u25C0 Prev</button>'
      + '<button class="merge-btn merge-nav" id="merge-next-btn" data-tooltip="Next change">Next \u25B6</button>'
      + '</div>'
      + '<div class="merge-toolbar-row">'
      + '<button class="merge-btn merge-accept-all" id="merge-accept-all-btn" data-tooltip="Accept all changes">\u2713\u2713 Accept All</button>'
      + '<button class="merge-btn merge-reject-all" id="merge-reject-all-btn" data-tooltip="Reject all changes">\u2717\u2717 Reject All</button>'
      + '</div>'
      + '</div>';
    O.appendChild(bar);
